...
public class Profile {
    ...
    ArrayList<Interest_Group> user_interest_groups = new ArrayList<>();
    ...
    public ArrayList<Interest_Group> getUser_interest_groups() {
        return user_interest_groups;
    }

    public void setUser_interest_groups(ArrayList<Interest_Group> user_interest_groups) {
        this.user_interest_groups = user_interest_groups;
    }
